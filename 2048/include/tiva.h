...
#define DMA_SRCENDP(p) REG(p + 0x000) // DMA Channel Source Address End Pointer (p. 609)
#define DMA_DSTENDP(p) REG(p + 0x004) // DMA Channel Destination Address End Pointer (p. 610)
#define DMA_CHCTL(p) REG(p + 0x008) // DMA Channel Control Word (p. 611)
#define DMA_STAT(p) REG(p + 0x000) // DMA Status (p. 616)
#define DMA_CFG(p) REG(p + 0x004) // DMA Configuration (p. 618)
#define DMA_CTLBASE(p) REG(p + 0x008) // DMA Channel Control Base Pointer (p. 619)
#define DMA_ALTBASE(p) REG(p + 0x00C) // DMA Alternate Channel Control Base Pointer (p. 620)
#define DMA_WAITSTAT(p) REG(p + 0x010) // DMA Channel Wait-on-Request Status (p. 621)
#define DMA_SWREQ(p) REG(p + 0x014) // DMA Channel Software Request (p. 622)
#define DMA_USEBURSTSET(p) REG(p + 0x018) // DMA Channel Useburst Set (p. 623)
#define DMA_USEBURSTCLR(p) REG(p + 0x01C) // DMA Channel Useburst Clear (p. 624)
#define DMA_REQMASKSET(p) REG(p + 0x020) // DMA Channel Request Mask Set (p. 625)
#define DMA_REQMASKCLR(p) REG(p + 0x024) // DMA Channel Request Mask Clear (p. 626)
#define DMA_ENASET(p) REG(p + 0x028) // DMA Channel Enable Set (p. 627)
#define DMA_ENACLR(p) REG(p + 0x02C) // DMA Channel Enable Clear (p. 628)
#define DMA_ALTSET(p) REG(p + 0x030) // DMA Channel Primary Alternate Set (p. 629)
#define DMA_ALTCLR(p) REG(p + 0x034) // DMA Channel Primary Alternate Clear (p. 630)
#define DMA_PRIOSET(p) REG(p + 0x038) // DMA Channel Priority Set (p. 631)
#define DMA_PRIOCLR(p) REG(p + 0x03C) // DMA Channel Priority Clear (p. 632)
#define DMA_ERRCLR(p) REG(p + 0x04C) // DMA Bus Error Clear (p. 633)
#define DMA_CHASGN(p) REG(p + 0x500) // DMA Channel Assignment (p. 634)
#define DMA_CHIS(p) REG(p + 0x504) // DMA Channel Interrupt Status (p. 635)
#define DMA_CHMAP0(p) REG(p + 0x510) // DMA Channel Map Select 0 (p. 636)
#define DMA_CHMAP1(p) REG(p + 0x514) // DMA Channel Map Select 1 (p. 637)
#define DMA_CHMAP2(p) REG(p + 0x518) // DMA Channel Map Select 2 (p. 638)
#define DMA_CHMAP3(p) REG(p + 0x51C) // DMA Channel Map Select 3 (p. 639)
#define DMA_PeriphID4(p) REG(p + 0xFD0) // DMA Peripheral Identification 4 (p. 644)
#define DMA_PeriphID0(p) REG(p + 0xFE0) // DMA Peripheral Identification 0 (p. 640)
#define DMA_PeriphID1(p) REG(p + 0xFE4) // DMA Peripheral Identification 1 (p. 641)
#define DMA_PeriphID2(p) REG(p + 0xFE8) // DMA Peripheral Identification 2 (p. 642)
#define DMA_PeriphID3(p) REG(p + 0xFEC) // DMA Peripheral Identification 3 (p. 643)
#define DMA_PCellID0(p) REG(p + 0xFF0) // DMA PrimeCell Identification 0 (p. 645)
#define DMA_PCellID1(p) REG(p + 0xFF4) // DMA PrimeCell Identification 1 (p. 646)
#define DMA_PCellID2(p) REG(p + 0xFF8) // DMA PrimeCell Identification 2 (p. 647)
#define DMA_PCellID3(p) REG(p + 0xFFC) // DMA PrimeCell Identification 3 (p. 648)
//                                                                            //
//                               uDMA Registers                               // 
//                                                                            //
